...
from sitedefs import JQUERY_JS, JQUERY_UI_JS, JQUERY_UI_CSS, TINYMCE_4_JS
...
""" % { "title": title, 
      "scripts": css_tag("tablesorter/theme.asm.css") + 
                 ...
                 script_tag("header_avid.js") + 
                 script_tag("header_edit_header.js") + 
                 script, 
      "bgcol":   bgcol }

def tinymce_header(title, js):
    """
...
def json_menu(l, reports, mailmerges):
    ...
    structure = (
        ("", "asm", _("ASM", l), (
            ...
            ( users.VIEW_ANIMAL, "v", "", "shelterview", "asm-icon-location", _("Shelter view", l) ),
            ( users.VIEW_ANIMAL, "f", "", "animal_find", "asm-icon-animal-find", _("Find animal", l) ),
            ( users.ADD_ANIMAL, "n", "", "animal_new", "asm-icon-animal-add", _("Add a new animal", l) ),
            ( users.ADD_LOG, "l", "", "log_new", "asm-icon-log", _("Add a log entry", l) ),
            ( users.ADD_LITTER, "", "", "litters", "asm-icon-litter", _("Edit litters", l) ),
            ( "", "", "", "--cat", "asm-icon-person", _("People", l) ),
            ( users.VIEW_PERSON, "p", "", "person_find", "asm-icon-person-find", _("Find person", l) ),
            ...
            ( "", "", "", "--break", "", "" ),
            ( "", "", "tagwaitinglist", "--cat", "asm-icon-blank", _("Waiting List", l) ),
            ( users.ADD_WAITING_LIST, "", "tagwaitinglist", "waitinglist_new", "asm-icon-blank", _("Add an animal to the waiting list", l) ),
            ( users.VIEW_WAITING_LIST, "w", "tagwaitinglist", "waitinglist_results", "asm-icon-waitinglist", _("Edit the current waiting list", l) ),
            ( "", "", "", "--cat", "asm-icon-blank", _("Diary", l) ),
            ( users.ADD_DIARY, "", "", "diary_edit_my?newnote=1", "asm-icon-blank", _("Add a diary note", l) ),
            ( users.EDIT_MY_DIARY_NOTES, "", "", "diary_edit_my", "asm-icon-diary", _("My diary notes", l) ),
        ...
        (users.VIEW_MOVEMENT, "move", _("Move", l), (
            ...
            ( users.ADD_MOVEMENT, "o", "", "move_foster", "asm-icon-blank", _("Foster an animal", l) ),
            ( users.ADD_MOVEMENT, "", "", "move_transfer", "asm-icon-blank", _("Transfer an animal", l) ),
            ( users.ADD_MOVEMENT, "a", "", "move_adopt", "asm-icon-person", _("Adopt an animal", l) ),
            ...
            ( users.ADD_ANIMAL, "", "n", "animal_new", "asm-icon-animal-add", _("Induct a new animal", l) ),
        ...
        ("", "financial", _("Financial", l), (
            ( users.VIEW_ACCOUNT, "x", "tagaccounts", "accounts", "asm-icon-accounts", _("Accounts", l) ),
            ( users.VIEW_DONATION, "", "tagaccounts", "--cat", "", "Donations" ),
            ( users.ADD_DONATION, "d", "tagaccounts", "donation", "asm-icon-donation", _("Donation book", l) ),
            ( users.ADD_DONATION, "", "tagaccounts", "donation_receive", "asm-icon-blank", _("Receive a donation", l) ),
        ...
        (users.USE_INTERNET_PUBLISHER, "publishing", _("Publishing", l), (
            ...
            ("", "", "", "publish?mode=pf", "asm-icon-blank", _("Publish to PetFinder.com", l) ),
            ("", "", "", "publish?mode=ap", "asm-icon-blank", _("Publish to AdoptAPet.com", l) ),
            ("", "", "", "publish?mode=rg", "asm-icon-blank", _("Publish to RescueGroups.org", l) ),
            ("", "", "", "publish?mode=mp", "asm-icon-blank", _("Publish to MeetAPet.com", l) ),
            ("", "", "", "publish?mode=hlp", "asm-icon-blank", _("Publish to HelpingLostPets.com", l) ),
            ("", "", "", "publish?mode=pl", "asm-icon-blank", _("Update animals with PetLink Microchips", l)),
            ("", "", "", "publish?mode=st", "asm-icon-blank", _("Update animals with SmartTag Pet ID", l)),

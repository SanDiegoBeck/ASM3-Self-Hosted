...
VERSION = "3.3.1 [Mon Feb 10 09:47:01 GMT 2014]"
BUILD = "02100947"
...
locale_maps = {
    "en":       ( MDY, DOLLAR, PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "en_GB":    ( DMY, POUND, PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "en_AU":    ( DMY, DOLLAR, PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "en_BH":    ( MDY, "BD", PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "en_CA":    ( MDY, DOLLAR, PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "en_CN":    ( YMD, YEN, PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "en_KW":    ( MDY, "KD", PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "en_KY":    ( DMY, DOLLAR, PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "en_IE":    ( DMY, EURO, PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "en_IN":    ( DMY, "Rs.", PLURAL_ENGLISH, CURRENCY_PREFIX),
    "en_PH":    ( DMY, "&#x20b1;", PLURAL_ENGLISH, CURRENCY_PREFIX),
    "en_NZ":    ( DMY, DOLLAR, PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "en_TH":    ( DMY, "&#x0e3f;", PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "en_TW":    ( DMY, DOLLAR, PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "en_VN":    ( DMY, "&#8363;", PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "en_ZA":    ( YMD, "R", PLURAL_ENGLISH, CURRENCY_PREFIX),
    "bg":       ( DMY, "&#x043b;&#x0432;", PLURAL_ENGLISH, CURRENCY_SUFFIX),
    "bs":       ( DMY, "KM", PLURAL_ENGLISH, CURRENCY_PREFIX),
    "cs":       ( YMD, "&#x004b;&#x010d;", PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "de":       ( DMY, EURO, PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "el":       ( DMY, EURO, PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "es":       ( DMY, EURO, PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "es_EC":    ( DMY, DOLLAR, PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "es_MX":    ( DMY, DOLLAR, PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "et":       ( DMY, "kr", PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "fr":       ( DMY, EURO, PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "he":       ( DMY, "&#x20aa;", PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "it":       ( DMY, EURO, PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "lt":       ( YMD, "Lt", PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "nb":       ( DMY, "kr", PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "nl":       ( DMY, EURO, PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "pl":       ( DMY, "&#x007a;&#x0142;", PLURAL_POLISH, CURRENCY_PREFIX ),
    "pt":       ( DMY, EURO, PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "ru":       ( DMY, "&#1056;&#1059;&#1041;.", PLURAL_SLAVIC, CURRENCY_PREFIX ),
    "sk":       ( DMY, EURO, PLURAL_SLAVIC, CURRENCY_PREFIX ),
    "sl":       ( DMY, EURO, PLURAL_SLAVIC, CURRENCY_PREFIX ),
    "sv":       ( DMY, "kr", PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "th":       ( DMY, "&#x0e3f;", PLURAL_ENGLISH, CURRENCY_PREFIX ),
    "tr":       ( DMY, "TL", PLURAL_ENGLISH, CURRENCY_PREFIX )
}
...
def real_locale(locale = "en"):
    ...
    if locale in ("en_IE", "en_IN", "en_NZ", "en_PH", "en_TH", "en_TW", "en_VN", "en_ZA"):
        locale = "en_GB"
    if locale in ("en_CA", "en_KY", "en_KW", "en_BH"):
        locale = "en"
    if locale in ("en_NZ",):
        locale = "en_AU"
...
def python2avid(d):
    """
    Formats a python date as an AVID format string yyyyMMdd. 'd' is
    a Python date, return value is an AVID string.
    """
    if d is None: return ""
    try:

    ...
    var login = {
        render: function() {
            var h = [
                ...
                '<div class="centered" style="margin-bottom: 5px">',
                    '<span id="forgottenpassword" style="display: none; margin-top: 5px"><a href="#">' + _("Forgotten password?") + '</a></span>',
                '</div>',
        ...
        bind: function() {
            ...
            if (controller.smcom) {
                ...
                qrurl = qrurl.substring(0, qrurl.lastIndexOf("/"));
                qrurl += "/mobile_login";
                var qr = "http://chart.apis.google.com/chart?";
                qr += "cht=qr&chl=" + qrurl + "&chs=120x120";
                $("#qr")
                    .attr("src", qr)

...
$(function() {
    ...
    var dialog = {
        ...
        fields: [
            ...
            { json_field: "DONATIONTYPEID", post_field: "donationtype", label: _("Donation Type"), type: "select", 
                tooltip: _("This income account is the source for donations received of this type"),
    ...
    var buttons = [
         { id: "new", text: _("New Account"), icon: "new", enabled: "always", 
             click: function() { 
